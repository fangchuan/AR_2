...
/*********************************************************************************************************
*	函 数 名: FLASH_SPI_Init
*	功能说明: FLASH要用到的SPI引脚和外设初始化
*	形    参：
*	返 回 值: 
*********************************************************************************************************
*/
void FLASH_SPI_Init(void)
{
  	...
  	SPI_InitTypeDef  SPI_InitStructure;
		...
		RCC_APB2PeriphClockCmd(	FLASH_SPI_GPIO_CLK, ENABLE );//PORTB时钟使能 
...
*	形    参：pBuffer:数据存储区,ReadAddr:开始读取的地址(24bit),NumByteToRead:要读取的字节数(最大65535)
*	返 回 值: 
*********************************************************************************************************
*/	
...
*	功能说明: SPI在一页(0~65535)内写入少于256个字节的数据,在指定地址开始写入最大256字节的数据
*	形    参：pBuffer:数据存储区,WriteAddr:开始写入的地址(24bit),NumByteToWrite:要写入的字节数(最大256),该数不应该超过该页的剩余字节数!!!
*	返 回 值: 
*********************************************************************************************************
*/	
...
*	形    参：pBuffer:数据存储区,WriteAddr:开始写入的地址(24bit),NumByteToWrite:要写入的字节数(最大256)
*	返 回 值: 
*********************************************************************************************************
*/	
...
*	形    参：pBuffer:数据存储区,WriteAddr:开始写入的地址(24bit),NumByteToWrite:要写入的字节数(最大16384) 
*	返 回 值: 
*********************************************************************************************************
*/	
